...
from .views import (
    ...
    AtributoUpdateAPIView,
    AtributoCreateAPIView,
    AtributoDetailAPIView,
    # -------- ★★★ NUEVO ENDPOINT ORDEN COMPRA ---------- #
    OrdenCompraListAPIView,
    OrdenCompraDetailAPIView,
...
urlpatterns = [
    ...
    path("logistica/tipo-marca-producto-completo/", TipoMarcaProductoJoinDetailAPIView.as_view(), name="tipo-marca-producto-completo-detalle"),
    ...
    path("logistica/modelo-producto-atributos/", ModeloProductoAtributosAPIView.as_view(), name="modelo-producto-atributos"),
    ...
    path("logistica/orden-compra/detalle/", OrdenCompraDetailAPIView.as_view(), name="orden-compra-detalle"),
